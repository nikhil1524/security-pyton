...
public class AuthAPI extends AsyncTask<Void, Void, String> {

    private int userId;
    private String sessionId;
    private String otp;

    public AuthAPI(int userId, String sessionId, String otp){
        this.userId = userId;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            URL uri = new URL("http://www.pawankpandey.info/verifyotp.php");
    ...
    protected void onPostExecute(String results) {
        if (results!=null && results.length() > 0) {
            AuthRepository.getAuthRepository().setResponse(results);
            AuthRepository.getAuthRepository().setResponseReceived(true);
        }
    }
