...
public class LoginAPI extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            URL uri = new URL("https://www.pawankpandey.info/loginapinew.php");
            ...
            inputParam.put("mobileNo", user.getMobileNo());
            inputParam.put("password", user.getPassword());
    ...
    protected void onPostExecute(String results) {
        if (results!=null && results.length() > 0) {
            LoginRepository.getLoginRepository().setResponse(results);
            LoginRepository.getLoginRepository().setResponseReceived(true);
            //Log.e("results login : ", results);
        }
    }
